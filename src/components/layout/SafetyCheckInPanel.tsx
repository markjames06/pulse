...
export const SafetyCheckInPanel: React.FC<SafetyCheckInPanelProps> = ({
  ...
  return (
    <section className={`safety-panel absolute bottom-[9rem] left-3 right-3 md:bottom-6 md:right-auto z-[1000] max-w-sm rounded-2xl bg-white/95 border border-black/10 shadow-xl p-3 backdrop-blur-sm ${isSidebarOpen ? 'md:left-[17rem]' : 'md:left-[5.75rem]'}`}>
